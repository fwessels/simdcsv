...
For the inner workings of both stages this repository contains both Golang code as well (generated) assembly. 

The main loop for both stages is more or less as follows:
